...
public class WeatherModel
    {
        public WeatherModelRS response { get; set; }
        public WeatherModelCO current_observation { get; set; }
    }

    public class WeatherModelRS 
    {

        public string version { get; set; }
        public string termsofService { get; set; }
        public Features features { get; set; }
        public string WeatherModelCondition { get; set; }
    ...
    public class WeatherModelCO {
        public WeatherModelImg image { get; set; }
        public WeatherModelDL display_location { get; set; }
        public WeatherModelOL observation_location { get; set; }
        public WeatherModelES estimated { get; set; }
